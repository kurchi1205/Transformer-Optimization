...
def build_transformer(src_seq_len, tgt_seq_len, d_model, N, head, dropout):
    model = T5(
        dim = d_model,
        enc_num_tokens = src_seq_len,
        enc_depth = N,
        enc_heads = head,
        enc_dim_head = d_model//head,
        enc_mlp_mult = 4,
        dec_num_tokens = tgt_seq_len,
        dec_depth = N,
        dec_heads = head,
        dec_dim_head = d_model//head,
        dec_mlp_mult = 4,
        dropout = dropout,
        tie_token_emb = False
    )
